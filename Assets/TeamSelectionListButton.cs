...
public class TeamSelectionListButton : MonoBehaviour {
	...
	public void UpdateTeamSelectionButtonInfo(){
		...
		fighterOneName.text = team.Fighters[0].FirstName + " " + team.Fighters[0].FirstName;
		//fighterOneLevel.text = team.Fighters[0].Level.ToString();
		fighterTwoName.text = team.Fighters[1].FirstName + " " + team.Fighters[1].FirstName;
		//fighterTwoLevel.text = team.Fighters[1].Level.ToString();
		fighterThreeName.text = team.Fighters[2].FirstName + " " + team.Fighters[2].FirstName;
	...
	public void TempSelected(){
		...
		foreach (Fighter f in team.Fighters) {
