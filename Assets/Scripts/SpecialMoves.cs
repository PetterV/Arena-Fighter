...
{
    //Special Move 0
    public static void PowerStrike(Fighter attacker, Fighter defender, Fight1v1 fight)
    {
        ...
        {
			MonoBehaviour.print(attacker.FirstName + " used Power Strike!");
            tempPrintStats = true;
        }
    ...
    //Special Move 1
    public static void HealingSpell(Fighter attacker, Fight1v1 fight)
    {
