...
public class FightManager
{
    ...
    public void DailyTickFightChecks()
    {
		...
		foreach (MatchPlan match in GameController.GetComponent<GameController>().BookingManager.Calendar)
        {
            ...
            {
				GameController.GetComponent<GameController> ().PauseTicks();
	...
	public void FightSetup1v1(Character defender, Character challenger, GameObject fightPlanButton)
    {
        //Arrange a fight
	...
	public static void ArrangeFight1v1(Character f1, Character f2, string fightType, GameObject fightPlanButton)
    {
		new Fight1v1(f1, f2, fightType, fightPlanButton);
    }

    public static void PayOut(Audience audience, Character winner, Character loser, bool draw)
    {
